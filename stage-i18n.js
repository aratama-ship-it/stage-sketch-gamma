...
(function () {
  ...
  const TEXT = {
    ...
    "台本": "Script",
    "行を押して選ぶ。⠿ を持って並べ替え（Alt＋↑↓でも動かせます）。": "Click a line to select it. Drag ⠿ to reorder (Alt+↑↓ also works).",
    "台本の行": "Script lines",
    "選んだセリフ": "Selected line",
    "台本はまだありません": "No script yet",
    "行": " lines",
    "キューに割り当て済み": "Assigned to cues",
    "行のないVOXキュー": "VOX cues without a line",
    ...
    "新しいVOXキューを作って割り当てる": "Create and assign a new VOX cue",
    "キュー": "Cue",
    "1つのVOXキューに1行。別の行で使っているキューを選ぶと、その行から外れます。": "One line per VOX cue. Choosing a cue used by another line removes it from that line.",
    "↑ 上へ": "↑ Up",
    "↓ 下へ": "↓ Down",
    "この行を削除": "Delete this line",
    "行を削除しても、割り当てていたVOXキューは残ります（キューのメモが表示に使われます）。取り消しは画面上部の「一つ戻す」で。": "Deleting a line keeps its VOX cue (the cue memo is shown instead). Undo with the button at the top.",
    ...
    "← 前": "← Prev",
    "次 →": "Next →",
    "前のVOXキューへ": "To the previous VOX cue",
    "次のVOXキューへ": "To the next VOX cue",
    "3列表示": "3 columns",
    ...
    "← 前のキュー": "← Previous cue",
    "次のキュー →": "Next cue →",
    "前後のVOXキューへ移る": "Move to the previous or next VOX cue",
    "ありません": "None",
    "（文字なし）": "(no text)",
    ...
    "VOXキュー": "VOX cues",
    "いまのセリフ": "Current line",
    "このセクションのこの位置より前にVOXキューはありません。": "No VOX cue before this point in this section.",
    "（台本の行が見つかりません。キューのメモも空です）": "(No script line found, and the cue memo is empty)",
    "の瞬間へ移る": ": jump to this moment",
    "VOXキューの一覧（押すとその瞬間へ移る）": "VOX cue list (click to jump to that moment)",
    "このショーにはVOXキューがありません。タイムラインの「セリフ」段にキューを足すと、場面メモの台本の行がここに並びます。": "This show has no VOX cues. Add cues to the Dialogue row of the timeline and the script lines from the scene notes appear here.",
