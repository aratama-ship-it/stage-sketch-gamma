...
test("the app shell advances with the storage transaction code", () => {
  ...
  assert.match(stageHtml, /stage-sketch\.js\?v=2026092405/);
  assert.match(serviceWorker, /stage-sketch-gamma-shell-v300/);
  assert.match(serviceWorker, /\.\/stage-project-backup-store\.js\?v=2026092213/);
  assert.match(serviceWorker, /\.\/style\.css\?v=2026092350/);
  assert.match(serviceWorker, /\.\/stage-sketch\.js\?v=2026092405/);
});
