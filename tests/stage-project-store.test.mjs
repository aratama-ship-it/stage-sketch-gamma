...
test("the app shell advances with the storage transaction code", () => {
  ...
  assert.match(stageHtml, /style\.css\?v=2026092525/);
  assert.match(stageHtml, /stage-sketch\.js\?v=2026092525/);
  assert.match(serviceWorker, /stage-sketch-gamma-shell-v363/);
  assert.match(serviceWorker, /\.\/stage-project-backup-store\.js\?v=2026092523/);
  assert.match(serviceWorker, /\.\/style\.css\?v=2026092525/);
...
test("indoor standing reception venue keeps its 3D room layout outside show data", () => {
  ...
  assert.match(stageHtml, /stage-venues\.js\?v=2026092523/);
  assert.match(stageHtml, /stage-first-person\.js\?v=2026092508/);
  assert.match(serviceWorker, /stage-venues\.js\?v=2026092523/);
  assert.match(serviceWorker, /stage-first-person\.js\?v=2026092508/);
});
