...
test("the app shell advances with the storage transaction code", () => {
  ...
  assert.match(stageHtml, /style\.css\?v=2026092524/);
  assert.match(stageHtml, /stage-sketch\.js\?v=2026092524/);
  assert.match(serviceWorker, /stage-sketch-gamma-shell-v362/);
  assert.match(serviceWorker, /\.\/stage-project-backup-store\.js\?v=2026092523/);
  assert.match(serviceWorker, /\.\/style\.css\?v=2026092524/);
