...
test("collected UI fixes retain data while changing the visible controls", () => {
  ...
  assert.match(html, /stage-sketch\.js\?v=2026092414/);
  assert.match(serviceWorker, /CACHE_NAME = "stage-sketch-gamma-shell-v315"/);
  assert.match(serviceWorker, /"\.\/stage-sketch\.js\?v=2026092414"/);
